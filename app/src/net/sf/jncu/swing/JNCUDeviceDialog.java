...
public class JNCUDeviceDialog extends JNCUDialog {
    ...
    public void setDeviceInfo(NewtonInfo info) {
        ...
        getRomStageLabel().setText(info.getStage() + " " + romLang);
        getRomVersionLabel().setText(romVersion);
        getScreenDepthLabel().setText(info.getScreenDepth() + " bits per pixel");
        getScreenHeightLabel().setText(info.getScreenHeight() + " pixels");
        getScreenResolutionXLabel().setText(info.getScreenResolutionHorizontal() + " pixels per inch");
        getScreenResolutionYLabel().setText(info.getScreenResolutionVertical() + " pixels per inch");
        getScreenWidthLabel().setText(info.getScreenWidth() + " pixels");
