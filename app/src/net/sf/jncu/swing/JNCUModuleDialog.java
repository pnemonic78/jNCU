...
public class JNCUModuleDialog extends JNCUDialog implements WindowListener {
     ...
     * @param icon    the message icon.
     * @param message a descriptive message.
     * @param note    a short note describing the state of the operation.
     */
     ...
     *
     * @param nv an integer specifying the current value, between the maximum
