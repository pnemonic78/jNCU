...
public class FDILibrary implements FDConstants {
     ...
     *
     * @param val An integer between -536,870,912...536,870,911, inclusive.
     * @return An integer FDIL object.
     * @throws FDILNotInitializedException if the library is not initialized.
     ...
     *
     * @param obj An FDIL integer object.
     * @return A long.
     * @throws FDILNotInitializedException if the library is not initialized.
     ...
     *
     * @param type  One of the following constants: <tt>kImmedSpecial</tt>,
     *              <tt>kImmedCharacter</tt>, <tt>kImmedBoolean</tt>, or
     *              <tt>kImmedReserved</tt>.
     * @param value The value of the immediate object.
     ...
     *
     * @param obj          An FDIL immediate object.
     * @param typeAndValue A pointer to where the type should be stored. This value will
     ...
     *
     * @param val An Unicode character.
     * @return A character FDIL object.
     * @throws FDILNotInitializedException if the library is not initialized.
     */
     ...
     * <tt>FD_Handle FD_MakeWideChar(DIL_WideChar val)</tt>
     *
     * @param val An Unicode code point.
     * @return A character FDIL object.
     * @throws FDILNotInitializedException if the library is not initialized.
     */
     ...
     *
     * @param obj An FDIL character object.
     ...
     *
     * @param src      An array of DIL_WideChar objects to translate.
     * @param numChars How many characters to convert.
     ...
     *
     * @param encoding One of following constants: <tt>kFD_MacEncoding</tt>,
     ...
     *
     * @param obj An FDIL pointer object.
     ...
     *
     * @param obj     An FDIL pointer object.
     * @param newSize The size to set the object’s length to.
     * @throws FDILNotInitializedException    if the library is not initialized.
     * @throws ExpectedPointerObjectException
     ...
     *
     * @param size The length to make the binary object.
     * @param cls  Either {@code NULL} in which case the binary object is given a
     ...
     *
     * @param obj An FDIL binary object.
     ...
     *
     * @param val Any valid IEEE-754 floating point value.
     ...
     *
     * @param obj An FDIL real number object.
     * @return A double.
     * @throws FDILNotInitializedException if the library is not initialized.
     ...
     *
     * @param str A <tt>NULL</tt>-terminated series of less than 254 ASCII
     ...
     *
     * @param obj An FDIL symbol object.
     ...
     *
     * @param str A <tt>NULL</tt>-terminated series of ASCII characters; in
     ...
     *
     * @param unicodeStr <tt>NULL</tt>-terminated series of Unicode characters.
     * @return A string FDIL object.
     * @throws FDILNotInitializedException if the library is not initialized.
     * @throws NullPointerException
     */
     ...
     *
     * @param obj An FDIL string object.
     ...
     *
     * @param obj    An FDIL string object.
     * @param buffer Pointer to buffer for the C string.
     ...
     *
     * @param size       The size of the large binary object.
     * @param objClass   Either <tt>NULL</tt> in which case the large binary object is
     *                   given a default class, or a string that is passed to
     *                   <tt>FD_MakeSymbol</tt> and becomes the object’s class.
     * @param compressed A value indicating whether to compress the data when storing
     ...
     *
     * @param obj    An FDIL large binary object.
     * @param offset Where to start reading from, in bytes from the beginning of
     *               the binary object.
     ...
     *
     * @param obj    An FDIL large binary object.
     * @param offset Where to start writing from, in bytes from the beginning of
     *               the binary object.
     ...
     *
     * @param procsPtr A pointer to a struct with function pointers to the functions
     ...
     * @param cls  Either <tt>NULL</tt> in which case the array’s is given a
     *             default class, or a string that is passed to
     ...
     * object to the array.
     *
     * @param array An FDIL array object.
     * @param pos   Where to insert the item.
     ...
     *
     * @param array An FDIL array object.
     * @param pos   Where to begin removing array slots from.
     ...
     *
     * @param array An FDIL array object.
     * @param pos   Which array slot to set.
     ...
     *
     * @param array An FDIL array object.
     * @param pos   Which array slot to access.
     ...
     *
     * @param frame    An FDIL frame object.
     * @param slotName A C string for the slot name.
     * @param item     An FDIL object to store in that slot.
     ...
     *
     * @param obj An FDIL magic pointer object.
     * @return A long.
     * @throws FDILNotInitializedException   if the library is not initialized.
     ...
     *
     * @param obj1 An FDIL object.
     * @param obj2 An FDIL object.
     * @return Zero or non-zero.
     * @throws FDILNotInitializedException if the library is not initialized.
     */
     ...
     *
     * @param obj      The FDIL object to print.
     * @param writeFn  A <tt>DIL_WriteProc</tt> that prints out the formatted text.
     ...
     *
     * @param obj      An FDIL object.
     * @param writeFn  A <tt>DIL_WriteProc</tt> to actually write the streamed bytes.
     * @param userData A pointer to any data you wish to be passed on to your
     *                 {@code writeFn}.
     * @throws FDILNotInitializedException if the library is not initialized.
     ...
     * they were formed.
     *
     * @param readFn   A <tt>DIL_ReadProc</tt> to actually read the streamed bytes.
     * @param userData A pointer to any data you wish to be passed on to your
     *                 {@code readFn}.
     ...
     *
     * @param obj    An FDIL pointer object.
     * @param oClass An FDIL symbol object for the class, or <tt>kFD_NIL</tt>.
     * @throws FDILNotInitializedException    if the library is not initialized.
     * @throws ExpectedPointerObjectException
     * @throws InvalidClassException
     */
