...
public class DockingProtocol<P extends CDPacket, L extends CDPacketLayer<P>> implements DockCommandListener {
     ...
     * @throws PipeDisconnectedException if the state is set to disconnected.
     */
     ...
     * @throws BadPipeStateException     if the transition is invalid.
     ...
     *
     * @param cmd the result command with error.
