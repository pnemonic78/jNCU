...
public class Store implements Comparable<Store> {
     ...
     *
     * @param defaultStore true if the default store.
     */
     ...
     *
     * @param soupSignatures the signatures.
     */
     ...
     *
     * @param name      the soup name.
     * @param signature the soup signature.
     * @return the soup - {@code null} otherwise.
     */
