...
public class BitArrayInputStream extends InputStream {
	 ...
	 *             if length negative, or larger than 32 bits.
	 * @throws EOFException
	 *             if this input stream reaches the end before reading
	 *             <tt>length</tt> bits.
	 */
	 ...
	 *         <code>byte</code>.
	 * @throws EOFException
	 *             if this input stream reaches the end before reading 1 byte.
	 */
	 ...
	 *         <code>short</code>.
	 * @throws EOFException
	 *             if this input stream reaches the end before reading 2 bytes.
	 */
	 ...
	 *         <code>int</code>.
	 * @throws EOFException
	 *             if this input stream reaches the end before reading 4 bytes.
	 */
	 ...
	 *         <code>long</code>.
	 * @throws EOFException
	 *             if this input stream reaches the end before reading 8 bytes.
	 */
